...
How does exxon use AI/ML, what capacity do we get to work on that:
Integrated in most operations, low carbon solutions, not gone fully mature , started egtting towards it, 
We use it from day1


What specific skills expected:
coding , fullstack, frontend, bakend, data engg, snowflake, databricks, AI/ML
automating existing routine function,
carbon footprint, financial decisions, seismic analysis , etc are routine fn, need automating

where are they investing in IT in coming years:
we grow strategically as tech grows

currently investing in perfecting litium extraction and how oil is mined
carbon fuel cell, methane pyrolysis, low carbon building materials
they run supercomputer to research in data

they also allow leave for absence for higher education

problems in internship you get:

why exxonmobil better:
eployer of choice
invest on people 
dont layoff (they say)
